        ...
        <div className="col-6">
            <div className="order-div">
                ...
                <table className="custom-table">
                    ...
                    <tbody>
                        <tr>
                            <td><img className='img-cart' src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/shop/product-1-1.jpg" alt="image/photo" /></td>
                            <td className="td-middel"><p>Yidarton Women Summer Blue</p>
                            <h6>x2</h6></td>
                            <td rowSpan="1"><p>$180.90</p></td>
                        </tr>
                        <tr>
                            <td><img className='img-cart' src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/shop/product-2-1.jpg" alt="image/photo" /></td>
                            <td className="td-middel"><p>LDB MOON Women Summe</p>
                            <h6>x1</h6></td>
                            <td rowSpan="1"><p>$190.99</p></td>
                        </tr>
                        <tr>
                            <td><img className='img-cart' src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/shop/product-3-1.jpg" alt="image/photo" /></td>
