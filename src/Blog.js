        ...
        <>
            <div className="container row row_main">
                ...
                <div className="col-6">
                    <div className="row">
                        <div className="col-6">
                            <img className="first_img" src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/blog/blog-2.jpg" alt="image/photo" />
                        </div>
                    ...
                    <div className="row">
                        <div className="col-6">
                            <img className="first_img" src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/blog/blog-1.jpg" alt="image/photo" />
                        </div>
                        <div className="col-6 first_content">
                            <p>Healthy</p>
