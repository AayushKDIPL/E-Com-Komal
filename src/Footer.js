            ...
            <div className="container">
                <div className="d-flex m-5">
                    ...
                    <div className="col-3">
                        ...
                        <img className="m-1" style={{height: "50px",width:"200px", border:"2px solid black"}} src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/theme/app-store.jpg" alt="image/photo" />
                        <img className="m-1" style={{height: "50px",width:"200px", border:"2px solid black"}} src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/theme/google-play.jpg" alt="image/photo" />
                        <p>Secured Payment Gateways</p>
                        <div className="d-flex">
                            <img src="https://wp.alithemes.com/html/evara/evara-frontend/assets/imgs/theme/payment-method.png" alt="image/photo" />
                        </div>
                </div>
            </div>
